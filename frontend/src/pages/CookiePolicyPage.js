  ...
  const faqs = [
    {
      ...
      answer: "Çerezler, web sitelerinin tarayıcınıza yerleştirdiği küçük metin dosyalarıdır. Bu dosyalar, tercihlerinizi hatırlamak ve deneyiminizi kişiselleştirmek için kullanılır."
    },
    {
      question: "Çerezleri nasıl silebilirim?",
      answer: "Tarayıcı ayarlarınızdan çerezleri silebilirsiniz. Her tarayıcının farklı adımları vardır. Genellikle Ayarlar > Gizlilik > Çerezler bölümünden ulaşabilirsiniz."
    },
    {
      question: "Çerezleri engelleyebilir miyim?",
      answer: "Evet, tarayıcı ayarlarından çerezleri engelleyebilirsiniz. Ancak bu durumda web sitesinin bazı özellikleri düzgün çalışmayabilir."
    }
  ];
        ...
        <div className="legal-content">
          ...
          <section className="legal-section">
            ...
            <div className="legal-section-content">
              ...
              <p>
                Bu politika, hangi çerezleri kullandığımızı, neden kullandığımızı
                ve bunları nasıl yönetebileceğinizi açıklar.
              </p>
              ...
              <div className="cookie-banner-preview">
                ...
                <div className="cookie-banner-demo">
                  ...
                  <div className="cookie-banner-actions">
                    <button className="cookie-banner-btn accept">Kabul Et</button>
                    <button className="cookie-banner-btn settings">Ayarlar</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <table className="cookie-types-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Web sitesinin temel işlevleri için gereklidir. Oturum yönetimi ve güvenlik sağlar.</td>
                    <td>Oturum</td>
                    <td><span className="cookie-status required">Zorunlu</span></td>
                  </tr>
                  <tr>
                    <td><strong>Analitik Çerezler</strong></td>
                    <td>Ziyaretçi istatistiklerini toplamak ve site performansını ölçmek için kullanılır.</td>
                    <td>2 yıl</td>
                    <td><span className="cookie-status optional">İsteğe Bağlı</span></td>
                  </tr>
                  <tr>
                    <td><strong>Fonksiyonel Çerezler</strong></td>
                    <td>Dil tercihi, tema gibi kişiselleştirme ayarlarınızı hatırlar.</td>
                    <td>1 yıl</td>
                    <td><span className="cookie-status optional">İsteğe Bağlı</span></td>
                  </tr>
                  <tr>
                    <td><strong>Pazarlama Çerezleri</strong></td>
                    <td>İlgi alanlarınıza göre reklamlar sunmak için kullanılır.</td>
                    <td>6 ay</td>
                    <td><span className="cookie-status optional">İsteğe Bağlı</span></td>
                  </tr>
                </tbody>
              ...
              <ul className="legal-list">
                <li className="legal-list-item">
                  ...
                  <div className="legal-list-text">
                    <strong>Oturum Çerezi:</strong> Kullanıcı girişi ve güvenli oturum yönetimi
                  </div>
                </li>
                <li className="legal-list-item">
                  <div className="legal-list-icon">🛡️</div>
                  <div className="legal-list-text">
                    <strong>CSRF Token:</strong> Güvenlik saldırılarına karşı koruma
                  </div>
                </li>
                <li className="legal-list-item">
                  <div className="legal-list-icon">✓</div>
            ...
            <div className="legal-section-content">
              ...
              <div className="legal-info-box info">
                ...
                <div className="legal-info-box-content">
                  ...
                  IP adresleri anonimleştirilmiştir. Bu çerezler onayınız ile aktifleştirilir.
                  <br /><br />
            ...
            <div className="legal-section-content">
              ...
              <ul className="legal-list">
                ...
                <li className="legal-list-item">
                  <div className="legal-list-icon">📘</div>
                  <div className="legal-list-text">
                    <a href="https://support.microsoft.com/microsoft-edge/delete-cookies-in-microsoft-edge" target="_blank" rel="noopener noreferrer">
              ...
              <div className="legal-info-box warning">
                ...
                <div className="legal-info-box-content">
                  Çerezleri devre dışı bırakırsanız, web sitemizin bazı özellikleri
            ...
            <div className="legal-section-content">
              <div className="legal-accordion">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className={`legal-accordion-item ${expandedItems.includes(index) ? "open" : ""}`}
                  >
                    <div
